...
manifest_path = os.path.join(working_dir, 'Resources/manifest.json')
...
with open(f'{working_dir}/invoice.rc.temp', 'r', encoding='utf-16') as f:
...
with open(f'{working_dir}/invoice.rc', 'w', encoding="utf-16") as f:
